...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create welltodos-com-f9eb
  fly apps create welltodos-com-f9eb-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app welltodos-com-f9eb
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app welltodos-com-f9eb-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'welltodos-com-f9eb-staging' does not match app name in config file 'welltodos-com-f9eb'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name welltodos-com-f9eb-db
  fly postgres attach --app welltodos-com-f9eb welltodos-com-f9eb-db

  fly postgres create --name welltodos-com-f9eb-staging-db
  fly postgres attach --app welltodos-com-f9eb-staging welltodos-com-f9eb-staging-db
  ```
